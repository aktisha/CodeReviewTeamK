...
struct R: Rswift.Validatable {
  ...
  struct color {
    ...
    static let secondaryLabel = Rswift.ColorResource(bundle: R.hostingBundle, name: "secondaryLabel")
    ...
    #if os(iOS) || os(tvOS)
    /// `UIColor(named: "secondaryLabel", bundle: ..., traitCollection: ...)`
    @available(tvOS 11.0, *)
    @available(iOS 11.0, *)
    static func secondaryLabel(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIColor? {
      return UIKit.UIColor(resource: R.color.secondaryLabel, compatibleWith: traitCollection)
    }
    #endif
    ...
    /// `UIColor(named: "secondaryLabel", bundle: ..., traitCollection: ...)`
    @available(watchOSApplicationExtension 4.0, *)
    static func secondaryLabel(_: Void = ()) -> UIKit.UIColor? {
      return UIKit.UIColor(named: R.color.secondaryLabel.name)
    }
    #endif
